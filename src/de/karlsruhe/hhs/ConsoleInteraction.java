...
public class ConsoleInteraction {
    ...
    private final String startingMessage = "Please choose if you like to enter a binary(1) or a decimal(2) digit: ";
    private final String errorMessage = "Your format was incorrect and the interaction has ended. Feel free to try again.";
    private final String resultMessage = "You entered {0}, to the base {1} and in the two’s complement this is {2}.";
    public final short SHORT_MIN = Short.MIN_VALUE;
    public final short SHORT_MAX = Short.MAX_VALUE;
    private final String enterBinaryMessage = "Please enter a binary with up to 16 byte: ";
    ...
    public boolean binaryToDecimalFormatCheck(String digit) {
    ...
    public boolean decimalToBinaryFormatCheck(String digit) {
